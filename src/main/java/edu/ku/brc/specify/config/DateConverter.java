    ...
    public static enum DateFormats {
        MON_DAY_LYEAR(
                "[0123456789]?[0123456789]([ /\\.-])[0123456789]?[0123456789]\\1[0-9][0-9][0-9][0-9]")
                {
                    ...
                    @Override
                    public PartialDateEnum getPrecision(String dateStr) throws ParseException
                    {
                        ...
                        if (noMonth && noDay)
                        {
                            return PartialDateEnum.Year;
                        }
                        if (noDay)
                        {
                            return PartialDateEnum.Month;
                        }
                        return PartialDateEnum.Full;
                    }

                    @Override
                    public String adjustForPrecision(String dateStr, PartialDateEnum prec) throws ParseException
                    {
                        if (prec.equals(PartialDateEnum.Year))
                        {
                            return "01" + dateStr.substring(2,3) + "01" + dateStr.substring(5);
                        }
                        if (prec.equals(PartialDateEnum.Month))
                        {
                    ...
                    @Override
                    public String adjustForPrecisionOut(String dateStr, PartialDateEnum prec) throws ParseException
                    {
                        if (prec.equals(PartialDateEnum.Year))
                        {
        ...
        public abstract PartialDateEnum getPrecision(String original) throws ParseException;
        public abstract String adjustForPrecision(String original, PartialDateEnum prec) throws ParseException;
        public abstract String adjustForPrecisionOut(String original, PartialDateEnum prec) throws ParseException;
